...
* Discoverd two bugs on my sad old Ipad from 2014. The first one is a little space between the navbar and the Home carousel. The carousel is pushed down from the navbar. There is no such space on any of the other devices I've been testing on. 
